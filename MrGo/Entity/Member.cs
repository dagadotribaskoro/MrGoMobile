...
namespace MrGo.Entity
{
    public class Member 
    {
        ...
        public decimal member_activationcode { get; set; }//14
        ...
        public static string UpdateReSentCodeByEmail(string email)
        {
            return "Update  member set member_sms_sent ='0' where member_email = '" + email + "'";
        }
        ...
        {
            member_activationcode = RandomString(4);
