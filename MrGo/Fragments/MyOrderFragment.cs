...
{
    public class MyOrderFragment : Fragment
    {
        ...
        public MyOrderFragment(HomeActivity act, int member_id)
        {
        ...
        public override Android.Views.View OnCreateView(Android.Views.LayoutInflater inflater, Android.Views.ViewGroup container, Bundle savedInstanceState)
        {
            ...
            this.m_Adapter = new MyOrderTabAdapter(this.ChildFragmentManager, m_member_id);
